...
fn test_rect2d_corners() {
    ...
    assert_eq!(corners[0].x, 10.0); assert_eq!(corners[0].y, 20.0);  // bottom-left
    assert_eq!(corners[1].x, 20.0); assert_eq!(corners[1].y, 20.0);  // bottom-right
    assert_eq!(corners[2].x, 10.0); assert_eq!(corners[2].y, 30.0);  // top-left
    assert_eq!(corners[3].x, 20.0); assert_eq!(corners[3].y, 30.0);  // top-right
}

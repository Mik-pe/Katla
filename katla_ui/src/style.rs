...
impl ColorScheme {
    ...
    fn light() -> Self {
        Self {
            ...
            input_selection: Color::new(0.2, 0.4, 0.85, 0.25),
    ...
    fn classic() -> Self {
        Self {
            ...
            input_cursor: Color::from_rgb_hex(0xffffff),
            input_border_focused: Color::from_rgb_hex(0x4a9eff),
            input_selection: Color::new(0.35, 0.55, 0.95, 0.3),
...
impl ColorScheme {
    ...
    pub fn rcp() -> Self {
        let mut scheme = color_scheme!(
            ...
            text: 0xD9D9D9, 0x8C8C8C, 0x5A5A5A, 0xD97706,
            button: 0x3A3A3C, 0x48484A, 0x3D3D52, 0xD9D9D9,
            selection: 0xD97706, 0xE8913A, 0xB45309,

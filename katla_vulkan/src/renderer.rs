...
use crate::{
    ...
    MaterialPipelineCache, MaterialRegistry, RendererError, SkeletonDescriptorSet,
...
impl VulkanRenderer {
    pub fn init(
        ...
        let storage_descriptor_handle =
            DescriptorSetHandle::new(ResourceStorage::new().insert(storage_descriptor_set.set()));

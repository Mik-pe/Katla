...
Agent(
  ...
  model: "opus",
  prompt: "Read .Codex/skills/gfx-maintainer/SKILL.md and adopt that persona. [task details]"
)
...
Agent(
  ...
  model: "opus",
  prompt: "Read .Codex/skills/app-maintainer/SKILL.md and adopt that persona. [task details]"
)
```

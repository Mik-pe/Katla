// Billboard shader for camera-facing quads with alpha-blended icon textures.
//
// Renders a unit quad (-0.5 to 0.5 XY) that always faces the camera.
// Uses the model matrix translation for world position and view matrix
...
fn fs_main(in: VertexOutput) -> @location(0) vec4f {
    ...
    let color = albedo_sample.rgb * obj.base_color.rgb;
